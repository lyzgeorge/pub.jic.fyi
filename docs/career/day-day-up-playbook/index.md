...
# The Day Day Up Career Playbook in Action
...
**Want the full lecture-style textbook?** See the [Original Edition](./original/index.md), with worked scripts, practice sets, and cheat sheets per chapter.

## Contents

- [Chapter 1 - Resume & Application Materials](./chapter-1-resume-application-materials.md) - Write impact bullets, close experience gaps, and reach hiring managers through four channels.
- [Chapter 2 - Interview Preparation](./chapter-2-interview-preparation.md) - Turn a job description into a prep brief, build a lean story bank, and prioritize prep time.
- [Chapter 3 - Answering Interview Questions](./chapter-3-answering-interview-questions.md) - Match answer structure to question type, tell stories with the HEALER framework, and handle weakness and experience-gap questions.
- [Chapter 4 - Interview Dynamics & Follow-up](./chapter-4-interview-dynamics-follow-up.md) - Adjust strategy by interview round, ask questions that reveal the truth, and follow up with specific content.
- [Chapter 5 - Offers, Salary & Career Decisions](./chapter-5-offers-salary-career-decisions.md) - Negotiate before accepting, read the whole offer, and compare options against your own priorities.
- [Chapter 6 - Clear Workplace Communication](./chapter-6-clear-workplace-communication.md) - Use the "scissors method" to lead with the point, pick the right structure, and make commitments explicit.
