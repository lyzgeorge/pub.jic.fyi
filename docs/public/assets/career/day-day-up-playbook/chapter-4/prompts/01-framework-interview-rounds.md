...
INTERVIEW ROUNDS - Framework

ZONES / LAYOUT: Three side-by-side cards with clear progression from left to right. Recruiter: fit and logistics icon; Hiring manager: team problem icon; Senior leader: strategic trade-offs icon. Each card has one emphasis line.

LABELS: Use only the following exact, correctly spelled English words and phrases as appropriate: Recruiter; Fit + logistics; Hiring manager; Team problems; Senior leader; Judgment + trade-offs. Do not add Spanish or Chinese text. Do not invent figures or claims.
