...
A USEFUL FOLLOW-UP - Flowchart

ZONES / LAYOUT: Three connected cards in a left-to-right process. Gratitude: thank for a specific conversation detail. Gap: name the need you heard. Gift: connect one relevant experience or useful insight. Envelope icon at end.

LABELS: Use only the following exact, correctly spelled English words and phrases as appropriate: Gratitude; Specific detail; Gap; Need heard; Gift; Relevant experience. Do not add Spanish or Chinese text. Do not invent figures or claims.
