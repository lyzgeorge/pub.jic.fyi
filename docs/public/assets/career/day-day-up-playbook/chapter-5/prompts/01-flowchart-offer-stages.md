...
THREE OFFER STAGES — Flowchart

ZONES / LAYOUT: Three connected stages. Initial discussion tests broad alignment; verbal offer is where you request changes; written offer verifies all agreed terms before acceptance. Visually distinguish asking, negotiating and checking.

LABELS: Use only the following exact, correctly spelled English words and phrases as appropriate: Initial discussion; Range alignment; Verbal offer; Make your request; Written offer; Verify terms; Accept. Do not add Spanish or Chinese text. Do not invent figures or claims.
