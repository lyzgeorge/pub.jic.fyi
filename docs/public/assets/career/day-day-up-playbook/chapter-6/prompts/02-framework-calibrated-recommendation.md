...
CONFIDENT AND PRECISE — Framework

ZONES / LAYOUT: Three connected blocks left to right: Evidence limit: small sample; Directional signal: agrees with last quarter; Recommendation: test next step. A small solid line connects them, emphasizing that the recommendation is firm while evidence is accurately bounded.

LABELS: Use only the following exact, correctly spelled English words and phrases as appropriate: Evidence limit; Small sample; Directional signal; Last-quarter trend; Recommendation; Test next step. Do not add Spanish or Chinese text. Do not invent figures or claims.
